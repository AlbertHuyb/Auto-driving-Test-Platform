...
global_vel = Twist() # 速度
rate = rospy.Rate(5) # 更新频率5Hz，可以将频率调大以进行精细调节   
...
def motion():
	...
	while not rospy.is_shutdown(): 
		if ch == 'o':
			f = open('/home/ros/multifunction_test/src/dsrc_move/src/old.txt', 'r')
		elif ch == 'w':
			...
			f = open('/home/ros/multifunction_test/src/dsrc_move/src/youth.txt', 'r')
		else:
